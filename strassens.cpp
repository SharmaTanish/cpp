...
int main() {
  ...
  /*  vector<vector<int>> a = {{1, 3}, {7, 5}};
    ...
    Strassen_algorithm(a, b, 2, 2, 2, 2); */
   
/*    vector<vector<int>> a = {{2, 3, 1}, {7, 4, 1}, {9, -2, 1}};
    vector<vector<int>> b = {{9, -2, -1}, {5, 7, 3}, {8, 1, 0}};
    Strassen_algorithm(a, b, 3, 3, 3, 3); */
   ...
   /* vector<vector<int>> a = {{5, 7, 9, 10}, {2, 3, 3, 8}, {8, 10, 2, 3}, {3,3,4,8}};
    ...
    vector<vector<int>> a = {{2, 3, 4, 5}, {5, 4, 3, 2}, {1, 2, 1, 2}};
    vector<vector<int>> b = {{1, 3}, {3, -2}, {4, 1}, {3,5}};
    Strassen_algorithm(a, b, 3, 4, 4, 2);
